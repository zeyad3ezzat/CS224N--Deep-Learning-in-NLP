...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        X = pack_padded_sequence(X, lengths=source_lengths) #packing is used to prepare the input to LSTM
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for y_t in torch.split(Y,1):
          ...
          dec_state, new_o_t, _ = self.step(ybar_t, dec_state, enc_hiddens, enc_hiddens_proj, enc_masks)

          combined_outputs.append(new_o_t)
          o_prev=new_o_t
